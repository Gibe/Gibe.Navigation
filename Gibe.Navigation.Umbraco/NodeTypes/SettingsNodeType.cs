...
namespace Gibe.Navigation.Umbraco.NodeTypes
{
	...
	internal class SettingsNodeTypeTests
	{
		...
		public void FindNode_Returns_Settings_Node()
		{
			...
			var settingsNode = settingsNodeType.FindNode(new[] {rootNodeMock1.Object, rootNodeMock2.Object}, null);
		...
		public void FindNode_Throws_InvalidOperationException_If_More_Than_One_Settings_Node()
		{
			...
			Assert.Throws<InvalidOperationException>(() => settingsNodeType.FindNode(new[] { rootNodeMock1.Object, rootNodeMock2.Object }, null));
		}
	}
}
